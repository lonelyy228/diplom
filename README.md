- [ ] «Разработка веб-платформы для продажи брендированной одежды с возможностью индивидуального дизайна и персонализации изделий методом вышивки и печати принтов»X
